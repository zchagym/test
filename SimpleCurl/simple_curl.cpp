...
int main(void)
{
	...
	string startTime = getTimeinSeconds("2020-04-01T16:00:00");
	string endTime = getTimeinSeconds("2020-04-20T16:00:00");
	...
	for (map<string, vector<double>>::iterator itr = Stocks.begin(); itr != Stocks.end(); itr++) {
		cout << itr->first << endl;
		for (auto ptr = itr->second.begin(); ptr != itr->second.end(); ptr++) cout << *ptr << " ";
		cout << endl << endl;
	}
	return 0;
}